    ...
    let app = app
        .invoke_handler({
            ...
            { tauri::generate_handler![
                ...
                themes::fonts::theme_font_status,
                themes::fonts::theme_font_download,
                ...
                search::notemd_search_plan_context,
                search::notemd_planned_search,
                ...
                smart_search::smart_search_freeze_sources,
