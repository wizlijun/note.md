...
export const en = {
  ...
  'smartSearch.placeholder': 'Ask anything or search your vault…',
  'smartSearch.inputHint': 'Instant preview as you type · Return understands and finds · ⇧Return adds a line',
  'smartSearch.modelFast': 'Automatic (fast)',
  'smartSearch.modelFallback': 'The previously selected model is unavailable; this Agent now uses its available fast model.',
  'smartSearch.modelDefault': 'Harness default',
  'smartSearch.quickPreview': 'Quick preview',
  'smartSearch.intelligentResults': 'Smart results',
  'smartSearch.results': 'Results',
  'smartSearch.sourceAll': 'All sources',
  'smartSearch.sourceDerived': 'AI-produced',
  'smartSearch.selectedCount': '{n} selected',
  'smartSearch.removeSelected': 'Remove from these results',
  'smartSearch.removedCount': '{n} hidden from this lookup',
  'smartSearch.undo': 'Undo',
  'smartSearch.notDeleted': 'Original files were not deleted.',
  'smartSearch.noContext': 'No usable results remain. Restore a result or change the query.',
  'smartSearch.activityTitle': 'Work log',
  'smartSearch.activityPlanStart': 'Interpreting intent, time range, and constraints',
  'smartSearch.activityAgentStarted': 'Started harness model: {model}',
  'smartSearch.activityStep': 'Harness completed background step {n}',
  'smartSearch.activityPlanReady': 'Search plan validated',
  'smartSearch.activitySearchStart': 'Executing the structured search plan',
  'smartSearch.activitySearchDone': 'Returned {n} results from {docs} documents',
  'smartSearch.activitySearchPartial': 'Search time limit reached; keeping {n} verified partial matches',
  'smartSearch.searchError': 'Search failed',
  'smartSearch.openEditor': 'Open in editor',
  'smartSearch.emptyPrompt': 'Type a question. Relevant notes will appear here immediately.',
  'smartSearch.settings': 'Smart Lookup settings',
  'smartSearch.lookup': 'Smart Lookup',
  'smartSearch.localAvailable': 'Local preview remains available without an Agent',
  'smartSearch.smartUnderstanding': 'Smart understanding',
  'smartSearch.smartUnderstandingHint': 'One fast Planner call after Return',
  'smartSearch.plannerProvider': 'Understanding Agent',
  'smartSearch.auto': 'Auto',
  'smartSearch.plannerModel': 'Understanding model',
  'smartSearch.resultLimit': 'Result limit',
  'smartSearch.groupBy': 'Group results',
  'smartSearch.groupSource': 'Source',
  'smartSearch.groupDate': 'Date',
  'smartSearch.autoDeep': 'Expand automatically when empty',
  'smartSearch.quickSummary': 'Quick summary',
  'smartSearch.summaryStyle': 'Summary format',
  'smartSearch.summaryBullets': 'Up to three bullets',
  'smartSearch.summarySentence': 'One paragraph',
  'smartSearch.includeRefs': 'Include selected references in handoff',
  'smartSearch.activityPreviewReady': 'Keeping the local instant preview available',
  'smartSearch.plannerDisabled': 'Smart understanding is off; showing ordinary matches.',
  'smartSearch.plannerUnavailable': 'No eligible Planner is available; showing ordinary matches.',
  'smartSearch.questionTooLong': 'The question is too long for quick understanding; showing ordinary matches.',
  'smartSearch.plannerFallback': 'Smart understanding did not complete; showing ordinary matches.',
  'smartSearch.activityDeepStart': 'Expanding the search with a bounded deep scan',
  'smartSearch.activityTime': 'Applied time range: {range}',
  'smartSearch.activityTerms': 'Understood topics: {terms}',
  'smartSearch.activitySummaryStart': 'Preparing a few complete current matches for quick summary',
  'smartSearch.activitySummaryDone': 'Quick summary completed and citations validated',
  'smartSearch.summaryUnavailable': 'Could not create a quick summary.',
  'smartSearch.handoffCopied': 'Handoff prompt copied',
  'smartSearch.activityHandoffStart': 'Starting a separate read-only Agent research run',
  'smartSearch.activityHandoffDone': 'Agent research run started',
  'smartSearch.handoffFailed': 'Could not start the Agent run.',
  'smartSearch.returnedCount': '{n} returned',
  'smartSearch.partialResults': '{n} results returned; some results may not be shown',
  'smartSearch.expandSearch': 'Expand search',
  'smartSearch.dateUnknown': 'Date unknown',
  'smartSearch.currentResult': 'Current result',
  'smartSearch.longBlockPreview': 'Bounded preview of a {type} result; open the source to read the full range.',
  'smartSearch.copyRef': 'Copy reference',
  'smartSearch.copyMarkdown': 'Copy Markdown link',
  'smartSearch.summaryLimitation': 'Based only on a few current complete line blocks; never automatic.',
  'smartSearch.generateSummary': 'Generate summary',
  'smartSearch.summaryNeedsLookup': 'Run Smart Lookup first. Preview results are not sent to a model.',
  'smartSearch.summaryAgentUnavailable': 'No Agent currently supports the input-only quick-summary task.',
  'smartSearch.summaryNeedsLine': 'Only long-document locators are available. Open the source to read it safely.',
  'smartSearch.summaryStale': '{n} changed sources were excluded from this summary.',
  'smartSearch.basedOnMatches': 'Based on current matches — not the complete Vault',
  'smartSearch.copySummary': 'Copy summary',
  'smartSearch.handoff': 'Hand to Agent',
  'smartSearch.deepAgentRecommended': 'This question needs deeper reading; references are only starting points.',
  'smartSearch.handoffHint': 'The Agent will re-search, read sources, and request Memory under its own identity.',
  'smartSearch.copyHandoff': 'Copy handoff prompt',
  'smartSearch.openAgentRun': 'Open Agent run',
  'smartSearch.staleNavigation': 'The file changed or the indexed position is stale. Refresh the search index.',
  'smartSearch.reasonExact': 'Exact',
  'smartSearch.reasonPhrase': 'Phrase',
  'smartSearch.reasonFilename': 'Filename',
  'smartSearch.reasonHeading': 'Heading',
  'smartSearch.reasonMultiple': 'Multiple queries',
  'smartSearch.reasonRelated': 'Related',
  'smartSearch.unsupported': 'Unsupported constraint',
  'smartSearch.ambiguous': 'Ambiguous constraint',
  'smartSearch.advancedSettings': 'Advanced settings',
  'smartSearch.plannerTimeout': 'Planner timeout (seconds)',
  'smartSearch.deepTimeout': 'Expanded-search timeout (seconds)',
  'smartSearch.summaryProvider': 'Summary Agent',
  'smartSearch.sameAsPlanner': 'Same as Planner',
  'smartSearch.summaryModel': 'Summary model',
  'smartSearch.summarySources': 'Summary sources',
  'smartSearch.summaryChars': 'Summary input characters',
  'smartSearch.summaryTimeout': 'Summary timeout (seconds)',
  'smartSearch.handoffProvider': 'Default handoff Agent',
