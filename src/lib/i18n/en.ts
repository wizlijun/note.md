...
export const en = {
  ...
  'pluginMarket.updateAllConfirm': 'Update all {count} plugins? This will automatically approve capability changes requested by these versions. Every package is still verified before installation.',
  ...
  'pluginMarket.openViewReloaded': '{name} was open, so its view was reloaded.',
  ...
  'agent.usageUnavailable': 'Token usage unavailable',
  'agent.usageTotal': '{n} tokens',
  'agent.usageInput': 'in {n}',
  'agent.usageCacheRead': 'cached {n}',
  ...
  // Smart Lookup
  'smartSearch.windowTitle': 'Smart Lookup',
  'smartSearch.placeholder': 'Describe what you want to find…',
  'smartSearch.inputHint': 'Return to find · Shift-Return for a new line',
  'smartSearch.modelFast': 'Automatic (fast)',
  'smartSearch.modelFallback': 'Your selected model is unavailable. A fast model is being used instead.',
  'smartSearch.modelDefault': 'Default model',
  'smartSearch.quickPreview': 'Local preview',
  'smartSearch.intelligentResults': 'Search results',
  'smartSearch.results': 'Results',
  'smartSearch.sourceAll': 'All sources',
  'smartSearch.sourceDerived': 'AI-generated',
  'smartSearch.selectedCount': '{n} selected',
  'smartSearch.removeSelected': 'Hide selected results',
  'smartSearch.removedCount': '{n} results hidden',
  'smartSearch.undo': 'Undo',
  'smartSearch.notDeleted': 'Original files were not deleted.',
  'smartSearch.noContext': 'No results to use. Undo hiding or try another question.',
  'smartSearch.activityTitle': 'Activity',
  'smartSearch.activityPlanStart': 'Identifying the time range and topics',
  'smartSearch.activityAgentStarted': 'Using {model}',
  'smartSearch.activityStep': 'Step {n} completed',
  'smartSearch.activityPlanReady': 'Search scope confirmed',
  'smartSearch.activitySearchStart': 'Finding notes in this scope',
  'smartSearch.activitySearchDone': 'Found {n} results in {docs} notes',
  'smartSearch.activitySearchPartial': 'Search time limit reached. {n} results are available.',
  'smartSearch.searchError': 'Search failed',
  'smartSearch.openEditor': 'Open original',
  'smartSearch.emptyPrompt': 'Describe a topic, a decision, or something you remember. Add a time range to narrow the search.',
  'smartSearch.settings': 'Search settings',
  'smartSearch.lookup': 'Find',
  'smartSearch.localAvailable': 'Local matching is available without AI.',
  'smartSearch.smartUnderstanding': 'Understand natural language',
  'smartSearch.smartUnderstandingHint': 'Recognize topics and time ranges before searching.',
  'smartSearch.plannerProvider': 'AI service',
  'smartSearch.auto': 'Auto',
  'smartSearch.plannerModel': 'Model',
  'smartSearch.resultLimit': 'Maximum results',
  'smartSearch.groupBy': 'Group results',
  'smartSearch.groupSource': 'Source',
  'smartSearch.groupDate': 'Date',
  'smartSearch.autoDeep': 'Search more broadly when nothing is found',
  'smartSearch.quickSummary': 'Quick answer',
  'smartSearch.summaryStyle': 'Answer format',
  'smartSearch.summaryBullets': 'Up to three bullets',
  'smartSearch.summarySentence': 'One paragraph',
  'smartSearch.includeRefs': 'Include selected results',
  'smartSearch.activityPreviewReady': 'Local matches are ready to browse',
  'smartSearch.plannerDisabled': 'Natural-language understanding is off. Showing local matches.',
  'smartSearch.plannerUnavailable': 'AI understanding is unavailable. Showing local matches.',
  'smartSearch.questionTooLong': 'Try a shorter question. Local matches are shown for now.',
  'smartSearch.plannerFallback': 'The question could not be interpreted. Local matches are still available.',
  'smartSearch.activityDeepStart': 'Searching more broadly',
  'smartSearch.activityTime': 'Applied time range: {range}',
  'smartSearch.activityTerms': 'Search topics: {terms}',
  'smartSearch.activitySummaryStart': 'Preparing relevant results for a short answer',
  'smartSearch.activitySummaryDone': 'Answer ready; references checked',
  'smartSearch.summaryUnavailable': 'Could not create a quick answer. Please try again.',
  'smartSearch.handoffCopied': 'Research instructions copied',
  'smartSearch.activityHandoffStart': 'Starting in-depth research',
  'smartSearch.activityHandoffDone': 'Research started',
  'smartSearch.handoffFailed': 'Could not start research. Please try again.',
  'smartSearch.returnedCount': '{n} results',
  'smartSearch.partialResults': 'Showing {n} results. More may be available.',
  'smartSearch.expandSearch': 'Expand search',
  'smartSearch.dateUnknown': 'Date unknown',
  'smartSearch.currentResult': 'Current result',
  'smartSearch.longBlockPreview': 'Partial preview ({type}). Open the original to keep reading.',
  'smartSearch.copyRef': 'Copy reference',
  'smartSearch.copyMarkdown': 'Copy Markdown link',
  'smartSearch.summaryLimitation': 'Create a short answer from a few relevant results when you need one.',
  'smartSearch.generateSummary': 'Create answer',
  'smartSearch.summaryNeedsLookup': 'Find results first to create a quick answer.',
  'smartSearch.summaryAgentUnavailable': 'No AI service is available for quick answers. Check search settings.',
  'smartSearch.summaryNeedsLine': 'These results need more context. Open the original or start in-depth research.',
  'smartSearch.summaryStale': '{n} sources changed and were left out of this answer.',
  'smartSearch.basedOnMatches': 'Based on the results used, which may not cover all your notes.',
  'smartSearch.copySummary': 'Copy answer',
  'smartSearch.handoff': 'In-depth research',
  'smartSearch.deepAgentRecommended': 'For a fuller answer, research can search further and read the original notes.',
  'smartSearch.handoffHint': 'Your AI assistant will search and read more notes in a separate research task.',
  'smartSearch.copyHandoff': 'Copy research instructions',
  'smartSearch.openAgentRun': 'Open research',
  'smartSearch.staleNavigation': 'This note has changed. Search again to find its current location.',
  'smartSearch.reasonExact': 'Exact match',
  'smartSearch.reasonPhrase': 'Phrase',
  'smartSearch.reasonFilename': 'Filename',
  'smartSearch.reasonHeading': 'Heading',
  'smartSearch.reasonMultiple': 'Several topics match',
  'smartSearch.reasonRelated': 'Related',
  'smartSearch.unsupported': 'Could not apply',
  'smartSearch.ambiguous': 'Needs clarification',
  'smartSearch.advancedSettings': 'Advanced settings',
  'smartSearch.plannerTimeout': 'Understanding time limit (seconds)',
  'smartSearch.deepTimeout': 'Expanded search time limit (seconds)',
  'smartSearch.summaryProvider': 'AI service for answers',
  'smartSearch.sameAsPlanner': 'Same as search',
  'smartSearch.summaryModel': 'Answer model',
  'smartSearch.summarySources': 'Maximum sources per answer',
  'smartSearch.summaryChars': 'Maximum input characters',
  'smartSearch.summaryTimeout': 'Answer time limit (seconds)',
  'smartSearch.handoffProvider': 'Research assistant',
  'smartSearch.askEveryTime': 'Ask every time',
  'smartSearch.clearQuery': 'Clear search',
  'smartSearch.stop': 'Stop',
  'smartSearch.stopped': 'Stopped',
  'smartSearch.retry': 'Try again',
  'smartSearch.editQuery': 'Edit question',
  'smartSearch.showAllSources': 'Show all sources',
  'smartSearch.noFilteredResults': 'No matching results from this source',
  'smartSearch.noResultsHint': 'Try a shorter topic or adjust the time range.',
  'smartSearch.emptyTitle': 'Find what you remember',
  'smartSearch.exampleRecent': 'What progress did our projects make last week?',
  'smartSearch.exampleDecision': 'Find decisions about the release plan',
  'smartSearch.keyboardHint': '↑↓ Browse · ↵ Open · {modifier}F Search',
  'smartSearch.searchShortcut': 'Describe what you need, then press Return to find it',
  'smartSearch.previewTab': 'Preview',
  'smartSearch.resultsTab': 'Results',
  'smartSearch.copyDone': 'Copied',
  'smartSearch.copyFailed': 'Could not copy. Please try again.',
  'smartSearch.showActivity': 'Show activity',
  'smartSearch.hideActivity': 'Hide activity',
  'smartSearch.settingsDone': 'Done',
  'smartSearch.settingsSearch': 'Understand the question',
  'smartSearch.settingsResults': 'Search results',
  'smartSearch.settingsSummary': 'Quick answer',
  'smartSearch.settingsHandoff': 'In-depth research',
  'smartSearch.previewHint': 'Select a result to read its preview here.',
  'smartSearch.previewLimited': 'Only part of the content is shown. Open the original to keep reading.',
  'smartSearch.dateScope': 'Time range',
  'smartSearch.topicsScope': 'Search topics',
  'smartSearch.sortNewest': 'Newest first',
  'smartSearch.sortOldest': 'Oldest first',
  'smartSearch.filterScope': 'Search scope',
  'smartSearch.sourceLabel': 'Source',
  'smartSearch.localMode': 'Local matches',
  'smartSearch.searching': 'Finding notes…',
  'smartSearch.understanding': 'Understanding your question…',
  'smartSearch.summaryWorking': 'Preparing a short answer…',
  'smartSearch.handoffWorking': 'Starting research…',
  'smartSearch.resultsCount': '{n} results',
  'smartSearch.documentCount': 'From {n} notes',
  'smartSearch.summarySelection': 'Using {n} selected results',
  'smartSearch.summaryVisible': 'Using current results',
  'smartSearch.openHint': 'Double-click or press Return to open the original',
  'smartSearch.settingsHint': 'Changes save automatically',
  'smartSearch.closePreview': 'Back to results',
  'smartSearch.copyOptions': 'Copy options',
  'smartSearch.clearSelection': 'Clear selection',
  'smartSearch.scopeFolder': 'Folder',
  'smartSearch.scopeTag': 'Tag',
  'smartSearch.scopeType': 'Type',
  'smartSearch.scopeFormat': 'Format',
  'smartSearch.scopePage': 'Linked note',
