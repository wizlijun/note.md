...
export const ja: Record<keyof Messages, string> = {
  ...
  'smartSearch.placeholder': 'Vault を検索、または質問…',
  'smartSearch.inputHint': '入力中は即時プレビュー · Return で理解して検索 · ⇧Return で改行',
  'smartSearch.modelFast': '自動（高速）',
  'smartSearch.modelFallback': '以前選択したモデルは利用できないため、この Agent の利用可能な高速モデルに切り替えました。',
  'smartSearch.modelDefault': 'Harness の既定値',
  'smartSearch.quickPreview': 'クイックプレビュー',
  'smartSearch.intelligentResults': 'スマート結果',
  'smartSearch.results': '結果',
  'smartSearch.sourceAll': 'すべての情報源',
  'smartSearch.sourceDerived': 'AI 生成',
  'smartSearch.selectedCount': '{n} 件選択',
  'smartSearch.removeSelected': '今回の結果から除外',
  'smartSearch.removedCount': '今回の検索から {n} 件非表示',
  'smartSearch.undo': '取り消す',
  'smartSearch.notDeleted': '元のファイルは削除されません。',
  'smartSearch.noContext': '利用できる結果がありません。結果を戻すか質問を変更してください。',
  'smartSearch.activityTitle': '作業ログ',
  'smartSearch.activityPlanStart': '意図、期間、制約を解析しています',
  'smartSearch.activityAgentStarted': 'Harness モデルを開始しました：{model}',
  'smartSearch.activityStep': 'Harness がバックグラウンド手順 {n} を完了しました',
  'smartSearch.activityPlanReady': '検索計画を検証しました',
  'smartSearch.activitySearchStart': '構造化検索計画を実行しています',
  'smartSearch.activitySearchDone': '{docs} 件の文書から {n} 件の結果を返しました',
  'smartSearch.activitySearchPartial': '検索時間の上限に達したため、検証済みの部分結果 {n} 件を使用します',
  'smartSearch.searchError': '検索に失敗しました',
  'smartSearch.openEditor': 'エディタで開く',
  'smartSearch.emptyPrompt': '質問を入力すると、関連ノートがすぐに表示されます。',
  'smartSearch.settings': 'スマート検索の設定',
  'smartSearch.lookup': 'スマート検索',
  'smartSearch.localAvailable': 'Agent がなくてもローカルプレビューを利用できます',
  'smartSearch.smartUnderstanding': 'スマート理解',
  'smartSearch.smartUnderstandingHint': 'Return 後に高速 Planner を 1 回だけ呼び出します',
  'smartSearch.plannerProvider': '理解に使う Agent',
  'smartSearch.auto': '自動',
  'smartSearch.plannerModel': '理解モデル',
  'smartSearch.resultLimit': '結果の上限',
  'smartSearch.groupBy': '結果のグループ化',
  'smartSearch.groupSource': 'ソース',
  'smartSearch.groupDate': '日付',
  'smartSearch.autoDeep': '結果がない場合に自動で検索を拡張',
  'smartSearch.quickSummary': 'クイック要約',
  'smartSearch.summaryStyle': '要約形式',
  'smartSearch.summaryBullets': '最大 3 つの箇条書き',
  'smartSearch.summarySentence': '短い 1 段落',
  'smartSearch.includeRefs': '引き継ぎに選択中の参照を含める',
  'smartSearch.activityPreviewReady': 'ローカルの即時プレビューを維持しています',
  'smartSearch.plannerDisabled': 'スマート理解は無効です。通常の一致結果を表示します。',
  'smartSearch.plannerUnavailable': '利用できる高速 Planner がありません。通常の一致結果を表示します。',
  'smartSearch.questionTooLong': '質問が高速理解の上限を超えました。通常の一致結果を表示します。',
  'smartSearch.plannerFallback': 'スマート理解を完了できませんでした。通常の一致結果を表示します。',
  'smartSearch.activityDeepStart': '制限時間内で検索範囲を拡張しています',
  'smartSearch.activityTime': '期間を適用しました：{range}',
  'smartSearch.activityTerms': '理解したトピック：{terms}',
  'smartSearch.activitySummaryStart': 'クイック要約用に現在の完全な一致を少数準備しています',
  'smartSearch.activitySummaryDone': 'クイック要約が完了し、引用を検証しました',
  'smartSearch.summaryUnavailable': 'クイック要約を作成できませんでした。',
  'smartSearch.handoffCopied': '引き継ぎプロンプトをコピーしました',
  'smartSearch.activityHandoffStart': '独立した読み取り専用 Agent 調査を開始しています',
  'smartSearch.activityHandoffDone': 'Agent 調査を開始しました',
  'smartSearch.handoffFailed': 'Agent を開始できませんでした。',
  'smartSearch.returnedCount': '{n} 件を表示',
  'smartSearch.partialResults': '{n} 件を表示しています。一部の結果は省略されている可能性があります',
  'smartSearch.expandSearch': '検索を拡張',
  'smartSearch.dateUnknown': '日付不明',
  'smartSearch.currentResult': '現在の結果',
  'smartSearch.longBlockPreview': '{type} 結果の範囲を制限したプレビューです。完全な範囲はソースを開いて確認してください。',
  'smartSearch.copyRef': '参照をコピー',
  'smartSearch.copyMarkdown': 'Markdown リンクをコピー',
  'smartSearch.summaryLimitation': '現在の完全な行ブロック少数だけに基づき、自動では実行されません。',
  'smartSearch.generateSummary': '要約を生成',
  'smartSearch.summaryNeedsLookup': '先にスマート検索を実行してください。プレビュー結果はモデルに送信されません。',
  'smartSearch.summaryAgentUnavailable': 'input-only のクイック要約に対応する Agent がありません。',
  'smartSearch.summaryNeedsLine': '長文の位置情報しかありません。安全に確認するには原文を開いてください。',
  'smartSearch.summaryStale': '変更された {n} 件のソースを今回の要約から除外しました。',
  'smartSearch.basedOnMatches': '現在の一致結果に基づくため、Vault 全体を表すものではありません',
  'smartSearch.copySummary': '要約をコピー',
  'smartSearch.handoff': 'Agent に引き継ぐ',
  'smartSearch.deepAgentRecommended': 'この質問には詳しい調査が必要です。参照は出発点にすぎません。',
  'smartSearch.handoffHint': 'Agent は自分で再検索してソースを読み、自身の ID で Memory を要求します。',
  'smartSearch.copyHandoff': '引き継ぎプロンプトをコピー',
  'smartSearch.openAgentRun': 'Agent 実行を開く',
  'smartSearch.staleNavigation': 'ファイルが変更されたか、インデックス位置が古くなっています。検索インデックスを更新してください。',
  'smartSearch.reasonExact': '完全一致',
  'smartSearch.reasonPhrase': 'フレーズ',
  'smartSearch.reasonFilename': 'ファイル名',
  'smartSearch.reasonHeading': '見出し',
  'smartSearch.reasonMultiple': '複数クエリ',
  'smartSearch.reasonRelated': '関連',
  'smartSearch.unsupported': '未対応の制約',
  'smartSearch.ambiguous': '曖昧な制約',
  'smartSearch.advancedSettings': '詳細設定',
  'smartSearch.plannerTimeout': 'Planner 待機時間（秒）',
  'smartSearch.deepTimeout': '拡張検索の制限時間（秒）',
  'smartSearch.summaryProvider': '要約 Agent',
  'smartSearch.sameAsPlanner': 'Planner と同じ',
  'smartSearch.summaryModel': '要約モデル',
  'smartSearch.summarySources': '要約ソース数',
  'smartSearch.summaryChars': '要約入力文字数',
  'smartSearch.summaryTimeout': '要約待機時間（秒）',
  'smartSearch.handoffProvider': '既定の引き継ぎ Agent',
