...
export const ja: Record<keyof Messages, string> = {
  ...
  'pluginMarket.restartHint': 'プラグインはインストールまたは更新後に自動で再読み込みされます。note.md の再起動は不要です。',
  ...
  'pluginMarket.updateAll': 'すべて更新（{count}）',
  'pluginMarket.updatingAll': '更新中 {done}/{total}…',
  'pluginMarket.updateAllConfirm': '{count} 個のプラグインをすべて更新しますか？これらのバージョンが要求する機能の変更は自動的に承認されます。各パッケージは引き続きインストール前に検証されます。',
  'pluginMarket.updateAllComplete': '{count} 個のプラグインを更新して再読み込みしました',
  'pluginMarket.updateAllPartial': '{succeeded} 個を更新、{failed} 個が失敗しました',
  'pluginMarket.cancel': 'キャンセル',
  'pluginMarket.installed': '{name} をインストールして読み込みました',
  'pluginMarket.updated': '{name} を更新して再読み込みしました',
  'pluginMarket.closedWindowReminder': '{name} の開いていたウインドウを閉じました。続けるにはプラグインを開き直してください。',
  'pluginMarket.closedWindowsSummary': '開いていたプラグインウインドウを閉じました。開き直してください。',
  'pluginMarket.closedWindowsBatch': '次のプラグインのウインドウを閉じました。開き直してください：{names}',
  'pluginMarket.openViewReloaded': '{name} が開いていたため、ビューを再読み込みしました。',
  'pluginMarket.reloadFailed': '{name} のバックグラウンドサービスを再読み込みできませんでした：{error}',
  ...
  'agent.doneError': '失敗',
  'agent.usageUnavailable': 'トークン使用量は報告されていません',
  'agent.usageTotal': '合計 {n} tokens',
  'agent.usageInput': '入力 {n}',
  'agent.usageCacheRead': 'キャッシュ読込 {n}',
  ...
  // スマート検索
  'smartSearch.windowTitle': 'スマート検索',
  'smartSearch.placeholder': '探したい内容を入力…',
  'smartSearch.inputHint': 'Return で検索 · Shift + Return で改行',
  'smartSearch.modelFast': '自動（高速）',
  'smartSearch.modelFallback': '選択したモデルは利用できないため、利用可能な高速モデルに切り替えました。',
  'smartSearch.modelDefault': '既定のモデル',
  'smartSearch.quickPreview': 'ローカルプレビュー',
  'smartSearch.intelligentResults': '検索結果',
  'smartSearch.results': '結果',
  'smartSearch.sourceAll': 'すべての情報源',
  'smartSearch.sourceDerived': 'AI 生成',
  'smartSearch.selectedCount': '{n} 件選択',
  'smartSearch.removeSelected': '選択した結果を非表示',
  'smartSearch.removedCount': '{n} 件の結果を非表示にしました',
  'smartSearch.undo': '取り消す',
  'smartSearch.notDeleted': '元のファイルは削除されません。',
  'smartSearch.noContext': '利用できる結果がありません。非表示を取り消すか、質問を変更してください。',
  'smartSearch.activityTitle': '作業状況',
  'smartSearch.activityPlanStart': '期間と検索テーマを確認しています',
  'smartSearch.activityAgentStarted': '{model} を使用しています',
  'smartSearch.activityStep': 'ステップ {n} が完了しました',
  'smartSearch.activityPlanReady': '検索範囲を確認しました',
  'smartSearch.activitySearchStart': 'この範囲でノートを検索しています',
  'smartSearch.activitySearchDone': '{docs} 件のノートから {n} 件見つかりました',
  'smartSearch.activitySearchPartial': '検索時間の上限に達しました。見つかった {n} 件を表示します。',
  'smartSearch.searchError': '検索に失敗しました',
  'smartSearch.openEditor': '原文を開く',
  'smartSearch.emptyPrompt': 'テーマや決定事項、覚えている一節を入力してください。期間を加えると絞り込めます。',
  'smartSearch.settings': '検索設定',
  'smartSearch.lookup': '検索',
  'smartSearch.localAvailable': 'AI がなくてもローカル検索を利用できます。',
  'smartSearch.smartUnderstanding': '自然な言葉で検索',
  'smartSearch.smartUnderstandingHint': '検索前に質問のテーマと期間を読み取ります。',
  'smartSearch.plannerProvider': 'AI サービス',
  'smartSearch.auto': '自動',
  'smartSearch.plannerModel': 'モデル',
  'smartSearch.resultLimit': '結果の最大件数',
  'smartSearch.groupBy': '結果のグループ化',
  'smartSearch.groupSource': 'ソース',
  'smartSearch.groupDate': '日付',
  'smartSearch.autoDeep': '見つからない場合は自動で検索を広げる',
  'smartSearch.quickSummary': 'クイック回答',
  'smartSearch.summaryStyle': '回答形式',
  'smartSearch.summaryBullets': '最大 3 つの箇条書き',
  'smartSearch.summarySentence': '短い 1 段落',
  'smartSearch.includeRefs': '選択中の結果を含める',
  'smartSearch.activityPreviewReady': 'ローカルの検索結果を確認できます',
  'smartSearch.plannerDisabled': '自然言語の理解はオフです。ローカルの検索結果を表示します。',
  'smartSearch.plannerUnavailable': 'AI による理解を利用できません。ローカルの検索結果を表示します。',
  'smartSearch.questionTooLong': '質問を短くしてお試しください。現在はローカルの検索結果を表示しています。',
  'smartSearch.plannerFallback': '質問を読み取れませんでした。ローカルの検索結果は引き続き確認できます。',
  'smartSearch.activityDeepStart': '検索範囲を広げています',
  'smartSearch.activityTime': '期間を適用しました：{range}',
  'smartSearch.activityTerms': '検索テーマ：{terms}',
  'smartSearch.activitySummaryStart': '関連する結果から短い回答をまとめています',
  'smartSearch.activitySummaryDone': '回答が完成し、参照を確認しました',
  'smartSearch.summaryUnavailable': 'クイック回答を作成できませんでした。もう一度お試しください。',
  'smartSearch.handoffCopied': '調査用の指示をコピーしました',
  'smartSearch.activityHandoffStart': '詳しい調査を開始しています',
  'smartSearch.activityHandoffDone': '調査を開始しました',
  'smartSearch.handoffFailed': '調査を開始できませんでした。もう一度お試しください。',
  'smartSearch.returnedCount': '{n} 件の結果',
  'smartSearch.partialResults': '{n} 件を表示しています。他にも結果がある可能性があります。',
  'smartSearch.expandSearch': '検索を拡張',
  'smartSearch.dateUnknown': '日付不明',
  'smartSearch.currentResult': '現在の結果',
  'smartSearch.longBlockPreview': '一部のプレビュー（{type}）です。続きは原文でお読みください。',
  'smartSearch.copyRef': '参照をコピー',
  'smartSearch.copyMarkdown': 'Markdown リンクをコピー',
  'smartSearch.summaryLimitation': '必要なときに、関連する少数の結果から短い回答を作成します。',
  'smartSearch.generateSummary': '回答を作成',
  'smartSearch.summaryNeedsLookup': '先に検索してから、クイック回答を作成してください。',
  'smartSearch.summaryAgentUnavailable': 'クイック回答に使える AI サービスがありません。検索設定を確認してください。',
  'smartSearch.summaryNeedsLine': 'この結果には詳しい文脈が必要です。原文を開くか、詳しい調査を開始してください。',
  'smartSearch.summaryStale': '変更された {n} 件の情報源は、この回答に使用していません。',
  'smartSearch.basedOnMatches': '使用した結果に基づくため、すべてのノートを網羅しているとは限りません。',
  'smartSearch.copySummary': '回答をコピー',
  'smartSearch.handoff': '詳しく調べる',
  'smartSearch.deepAgentRecommended': 'より詳しい回答が必要な場合は、検索を広げて原文を調べられます。',
  'smartSearch.handoffHint': 'AI アシスタントが別のタスクでノートを探し、詳しく読み進めます。',
  'smartSearch.copyHandoff': '調査用の指示をコピー',
  'smartSearch.openAgentRun': '調査を開く',
  'smartSearch.staleNavigation': 'ノートが変更されています。再検索して最新の内容を確認してください。',
  'smartSearch.reasonExact': '完全一致',
  'smartSearch.reasonPhrase': 'フレーズ',
  'smartSearch.reasonFilename': 'ファイル名',
  'smartSearch.reasonHeading': '見出し',
  'smartSearch.reasonMultiple': '複数のテーマに一致',
  'smartSearch.reasonRelated': '関連',
  'smartSearch.unsupported': '適用できません',
  'smartSearch.ambiguous': '確認が必要です',
  'smartSearch.advancedSettings': '詳細設定',
  'smartSearch.plannerTimeout': '質問の理解に使う時間（秒）',
  'smartSearch.deepTimeout': '拡張検索の制限時間（秒）',
  'smartSearch.summaryProvider': '回答用の AI サービス',
  'smartSearch.sameAsPlanner': '検索と同じ',
  'smartSearch.summaryModel': '回答モデル',
  'smartSearch.summarySources': '回答に使う情報源の最大件数',
  'smartSearch.summaryChars': '読み取る文字数の上限',
  'smartSearch.summaryTimeout': '回答の制限時間（秒）',
  'smartSearch.handoffProvider': '調査アシスタント',
  'smartSearch.askEveryTime': '毎回確認',
  'smartSearch.clearQuery': '検索をクリア',
  'smartSearch.stop': '停止',
  'smartSearch.stopped': '停止しました',
  'smartSearch.retry': '再試行',
  'smartSearch.editQuery': '質問を編集',
  'smartSearch.showAllSources': 'すべての情報源を表示',
  'smartSearch.noFilteredResults': 'この情報源には一致する結果がありません',
  'smartSearch.noResultsHint': 'テーマを短くするか、期間を変更してみてください。',
  'smartSearch.emptyTitle': '覚えていることから探す',
  'smartSearch.exampleRecent': '先週のプロジェクトの進捗は？',
  'smartSearch.exampleDecision': 'リリース計画に関する決定を探す',
  'smartSearch.keyboardHint': '↑↓ 移動 · ↵ 開く · {modifier}F 検索',
  'smartSearch.searchShortcut': '自然な言葉で入力し、Return で検索',
  'smartSearch.previewTab': '原文プレビュー',
  'smartSearch.resultsTab': '検索結果',
  'smartSearch.copyDone': 'コピーしました',
  'smartSearch.copyFailed': 'コピーできませんでした。もう一度お試しください。',
  'smartSearch.showActivity': '作業状況を表示',
  'smartSearch.hideActivity': '作業状況を閉じる',
  'smartSearch.settingsDone': '完了',
  'smartSearch.settingsSearch': '質問の理解',
  'smartSearch.settingsResults': '検索結果',
  'smartSearch.settingsSummary': 'クイック回答',
  'smartSearch.settingsHandoff': '詳しい調査',
  'smartSearch.previewHint': '結果を選択すると、ここでプレビューを読めます。',
  'smartSearch.previewLimited': '内容の一部を表示しています。続きは原文でお読みください。',
  'smartSearch.dateScope': '期間',
  'smartSearch.topicsScope': '検索テーマ',
  'smartSearch.sortNewest': '新しい順',
  'smartSearch.sortOldest': '古い順',
  'smartSearch.filterScope': '検索範囲',
  'smartSearch.sourceLabel': '情報源',
  'smartSearch.localMode': 'ローカル検索',
  'smartSearch.searching': 'ノートを検索しています…',
  'smartSearch.understanding': '質問を読み取っています…',
  'smartSearch.summaryWorking': '短い回答をまとめています…',
  'smartSearch.handoffWorking': '調査を開始しています…',
  'smartSearch.resultsCount': '{n} 件の結果',
  'smartSearch.documentCount': '{n} 件のノートから',
  'smartSearch.summarySelection': '選択した {n} 件の結果に基づきます',
  'smartSearch.summaryVisible': '現在の結果に基づきます',
  'smartSearch.openHint': 'ダブルクリックまたは Return で原文を開く',
  'smartSearch.settingsHint': '変更は自動保存されます',
  'smartSearch.closePreview': '結果に戻る',
  'smartSearch.copyOptions': 'コピーのオプション',
  'smartSearch.clearSelection': '選択を解除',
  'smartSearch.scopeFolder': 'フォルダ',
  'smartSearch.scopeTag': 'タグ',
  'smartSearch.scopeType': '種類',
  'smartSearch.scopeFormat': '形式',
  'smartSearch.scopePage': '関連ノート',
