...
export const zh: Record<keyof Messages, string> = {
  ...
  'pluginMarket.restartHint': '插件安装或更新后会自动重新加载，无需重新启动 note.md。',
  ...
  'pluginMarket.updateAll': '全部更新（{count}）',
  'pluginMarket.updatingAll': '正在更新 {done}/{total}…',
  'pluginMarket.updateAllConfirm': '更新全部 {count} 个插件？这会自动同意这些新版本请求的能力变更；每个安装包仍会在安装前完成安全校验。',
  'pluginMarket.updateAllComplete': '已更新并重新加载全部 {count} 个插件',
  'pluginMarket.updateAllPartial': '已更新 {succeeded} 个，{failed} 个失败',
  'pluginMarket.cancel': '取消',
  'pluginMarket.installed': '已安装并加载 {name}',
  'pluginMarket.updated': '已更新并重新加载 {name}',
  'pluginMarket.closedWindowReminder': '已关闭 {name} 的打开窗口，请重新打开。',
  'pluginMarket.closedWindowsSummary': '已关闭打开的插件窗口，请重新打开。',
  'pluginMarket.closedWindowsBatch': '已关闭以下插件的打开窗口，请重新打开：{names}',
  'pluginMarket.openViewReloaded': '{name} 已经打开，相关视图已重新加载。',
  'pluginMarket.reloadFailed': '{name} 的后台服务重新加载失败：{error}',
  ...
  'agent.doneError': '失败',
  'agent.usageUnavailable': 'Token 用量未报告',
  'agent.usageTotal': '共 {n} tokens',
  'agent.usageInput': '输入 {n}',
  'agent.usageCacheRead': '缓存读取 {n}',
  ...
  // 智能查找
  'smartSearch.windowTitle': '智能查找',
  'smartSearch.placeholder': '描述你想找的内容…',
  'smartSearch.inputHint': '回车查找 · Shift + 回车换行',
  'smartSearch.modelFast': '自动（快速）',
  'smartSearch.modelFallback': '所选模型暂不可用，已切换到可用的快速模型。',
  'smartSearch.modelDefault': '默认模型',
  'smartSearch.quickPreview': '本地预览',
  'smartSearch.intelligentResults': '查找结果',
  'smartSearch.results': '结果',
  'smartSearch.sourceAll': '全部来源',
  'smartSearch.sourceDerived': 'AI 生成',
  'smartSearch.selectedCount': '已选 {n} 条',
  'smartSearch.removeSelected': '隐藏所选结果',
  'smartSearch.removedCount': '已隐藏 {n} 条结果',
  'smartSearch.undo': '撤销',
  'smartSearch.notDeleted': '原文件没有被删除。',
  'smartSearch.noContext': '没有可用结果。请撤销隐藏，或换一个问题。',
  'smartSearch.activityTitle': '工作过程',
  'smartSearch.activityPlanStart': '正在识别时间范围和搜索主题',
  'smartSearch.activityAgentStarted': '正在使用 {model}',
  'smartSearch.activityStep': '已完成第 {n} 步',
  'smartSearch.activityPlanReady': '已确认查找范围',
  'smartSearch.activitySearchStart': '正在此范围内查找笔记',
  'smartSearch.activitySearchDone': '找到 {n} 条结果，来自 {docs} 篇笔记',
  'smartSearch.activitySearchPartial': '查找已达到时间上限，已找到的 {n} 条结果仍可查看。',
  'smartSearch.searchError': '搜索失败',
  'smartSearch.openEditor': '打开原文',
  'smartSearch.emptyPrompt': '可以描述一个主题、一项决定，或你记得的片段。加上时间，能找得更准。',
  'smartSearch.settings': '查找设置',
  'smartSearch.lookup': '查找',
  'smartSearch.localAvailable': '未连接 AI 时，仍可使用本地匹配。',
  'smartSearch.smartUnderstanding': '理解自然语言',
  'smartSearch.smartUnderstandingHint': '查找前，先识别问题中的主题和时间范围。',
  'smartSearch.plannerProvider': 'AI 服务',
  'smartSearch.auto': '自动',
  'smartSearch.plannerModel': '模型',
  'smartSearch.resultLimit': '最多显示结果数',
  'smartSearch.groupBy': '结果分组',
  'smartSearch.groupSource': '来源',
  'smartSearch.groupDate': '日期',
  'smartSearch.autoDeep': '未找到结果时自动扩大查找',
  'smartSearch.quickSummary': '快速简答',
  'smartSearch.summaryStyle': '简答格式',
  'smartSearch.summaryBullets': '最多三个要点',
  'smartSearch.summarySentence': '一个短段落',
  'smartSearch.includeRefs': '附上当前选择的结果',
  'smartSearch.activityPreviewReady': '本地匹配已就绪，可以先浏览',
  'smartSearch.plannerDisabled': '智能理解已关闭，当前显示本地匹配。',
  'smartSearch.plannerUnavailable': '智能理解暂不可用，当前显示本地匹配。',
  'smartSearch.questionTooLong': '问题较长，请试着精简。当前显示本地匹配。',
  'smartSearch.plannerFallback': '暂时未能理解问题，仍可浏览本地匹配。',
  'smartSearch.activityDeepStart': '正在扩大查找范围',
  'smartSearch.activityTime': '已应用时间范围：{range}',
  'smartSearch.activityTerms': '搜索主题：{terms}',
  'smartSearch.activitySummaryStart': '正在根据相关结果整理简答',
  'smartSearch.activitySummaryDone': '简答已完成，引用已核对',
  'smartSearch.summaryUnavailable': '暂时无法生成简答，请重试。',
  'smartSearch.handoffCopied': '研究说明已复制',
  'smartSearch.activityHandoffStart': '正在启动深入研究',
  'smartSearch.activityHandoffDone': '研究已启动',
  'smartSearch.handoffFailed': '暂时无法启动研究，请重试。',
  'smartSearch.returnedCount': '{n} 条结果',
  'smartSearch.partialResults': '已显示 {n} 条结果，可能还有更多。',
  'smartSearch.expandSearch': '扩大查找',
  'smartSearch.dateUnknown': '日期未知',
  'smartSearch.currentResult': '当前结果',
  'smartSearch.longBlockPreview': '部分预览（{type}）。打开原文继续阅读。',
  'smartSearch.copyRef': '复制引用',
  'smartSearch.copyMarkdown': '复制 Markdown 链接',
  'smartSearch.summaryLimitation': '需要时，可根据少量相关结果生成简短回答。',
  'smartSearch.generateSummary': '生成简答',
  'smartSearch.summaryNeedsLookup': '先查找相关结果，再生成简答。',
  'smartSearch.summaryAgentUnavailable': '暂无可用于简答的 AI 服务，请检查查找设置。',
  'smartSearch.summaryNeedsLine': '这些结果需要更多上下文，请打开原文或启动深入研究。',
  'smartSearch.summaryStale': '{n} 条来源已变化，未用于本次简答。',
  'smartSearch.basedOnMatches': '基于所用结果，可能未涵盖全部笔记。',
  'smartSearch.copySummary': '复制简答',
  'smartSearch.handoff': '深入研究',
  'smartSearch.deepAgentRecommended': '想了解得更完整，可以继续查找并深入阅读原文。',
  'smartSearch.handoffHint': 'AI 助手将在独立任务中继续查找和阅读笔记。',
  'smartSearch.copyHandoff': '复制研究说明',
  'smartSearch.openAgentRun': '查看研究',
  'smartSearch.staleNavigation': '笔记已变化，请重新查找以定位最新内容。',
  'smartSearch.reasonExact': '精确匹配',
  'smartSearch.reasonPhrase': '短语',
  'smartSearch.reasonFilename': '文件名',
  'smartSearch.reasonHeading': '标题',
  'smartSearch.reasonMultiple': '多个主题匹配',
  'smartSearch.reasonRelated': '相关',
  'smartSearch.unsupported': '暂无法应用',
  'smartSearch.ambiguous': '需要确认',
  'smartSearch.advancedSettings': '高级设置',
  'smartSearch.plannerTimeout': '理解问题时限（秒）',
  'smartSearch.deepTimeout': '扩大查找时限（秒）',
  'smartSearch.summaryProvider': '简答 AI 服务',
  'smartSearch.sameAsPlanner': '与理解问题相同',
  'smartSearch.summaryModel': '简答模型',
  'smartSearch.summarySources': '每次简答最多引用数',
  'smartSearch.summaryChars': '最多读取字符数',
  'smartSearch.summaryTimeout': '简答生成时限（秒）',
  'smartSearch.handoffProvider': '研究助手',
  'smartSearch.askEveryTime': '每次询问',
  'smartSearch.clearQuery': '清空搜索',
  'smartSearch.stop': '停止',
  'smartSearch.stopped': '已停止',
  'smartSearch.retry': '重试',
  'smartSearch.editQuery': '修改问题',
  'smartSearch.showAllSources': '显示全部来源',
  'smartSearch.noFilteredResults': '此来源没有匹配结果',
  'smartSearch.noResultsHint': '试试更短的主题，或调整时间范围。',
  'smartSearch.emptyTitle': '找回你记得的那一点',
  'smartSearch.exampleRecent': '上周有哪些项目进展？',
  'smartSearch.exampleDecision': '查找关于发布计划的决定',
  'smartSearch.keyboardHint': '↑↓ 浏览 · ↵ 打开 · {modifier}F 搜索',
  'smartSearch.searchShortcut': '用自然语言描述，按回车查找',
  'smartSearch.previewTab': '原文预览',
  'smartSearch.resultsTab': '搜索结果',
  'smartSearch.copyDone': '已复制',
  'smartSearch.copyFailed': '复制失败，请重试',
  'smartSearch.showActivity': '展开工作过程',
  'smartSearch.hideActivity': '收起工作过程',
  'smartSearch.settingsDone': '完成',
  'smartSearch.settingsSearch': '理解问题',
  'smartSearch.settingsResults': '搜索结果',
  'smartSearch.settingsSummary': '快速简答',
  'smartSearch.settingsHandoff': '深入研究',
  'smartSearch.previewHint': '选择一条结果，在这里阅读预览。',
  'smartSearch.previewLimited': '这里只显示部分内容，打开原文继续阅读。',
  'smartSearch.dateScope': '时间范围',
  'smartSearch.topicsScope': '搜索主题',
  'smartSearch.sortNewest': '最新优先',
  'smartSearch.sortOldest': '最早优先',
  'smartSearch.filterScope': '查找范围',
  'smartSearch.sourceLabel': '来源',
  'smartSearch.localMode': '本地匹配',
  'smartSearch.searching': '正在查找笔记…',
  'smartSearch.understanding': '正在理解问题…',
  'smartSearch.summaryWorking': '正在整理简答…',
  'smartSearch.handoffWorking': '正在启动研究…',
  'smartSearch.resultsCount': '{n} 条结果',
  'smartSearch.documentCount': '来自 {n} 篇笔记',
  'smartSearch.summarySelection': '基于已选的 {n} 条结果',
  'smartSearch.summaryVisible': '基于当前结果',
  'smartSearch.openHint': '双击或按回车打开原文',
  'smartSearch.settingsHint': '自动保存',
  'smartSearch.closePreview': '返回结果',
  'smartSearch.copyOptions': '复制选项',
  'smartSearch.clearSelection': '取消选择',
  'smartSearch.scopeFolder': '文件夹',
  'smartSearch.scopeTag': '标签',
  'smartSearch.scopeType': '类型',
  'smartSearch.scopeFormat': '格式',
  'smartSearch.scopePage': '关联笔记',
