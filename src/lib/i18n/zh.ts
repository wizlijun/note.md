...
export const zh: Record<keyof Messages, string> = {
  ...
  'smartSearch.placeholder': '搜索知识库，或直接提问…',
  'smartSearch.inputHint': '输入即时预览 · 回车理解并查找 · ⇧回车换行',
  'smartSearch.modelFast': '自动（快速）',
  'smartSearch.modelFallback': '先前选择的模型已不可用，已回退到该 Agent 的可用快速模型。',
  'smartSearch.modelDefault': 'Harness 默认',
  'smartSearch.quickPreview': '快速预览',
  'smartSearch.intelligentResults': '智能结果',
  'smartSearch.results': '结果',
  'smartSearch.sourceAll': '全部来源',
  'smartSearch.sourceDerived': 'AI 产出',
  'smartSearch.selectedCount': '已选 {n} 条',
  'smartSearch.removeSelected': '从本次结果移除',
  'smartSearch.removedCount': '已从本次查找隐藏 {n} 条',
  'smartSearch.undo': '撤销',
  'smartSearch.notDeleted': '原文件没有被删除。',
  'smartSearch.noContext': '没有可用结果。请恢复结果或换一个问题。',
  'smartSearch.activityTitle': '工作过程',
  'smartSearch.activityPlanStart': '正在识别意图、时间范围和约束条件',
  'smartSearch.activityAgentStarted': '已启动 Harness 模型：{model}',
  'smartSearch.activityStep': 'Harness 已完成后台步骤 {n}',
  'smartSearch.activityPlanReady': '检索计划已通过校验',
  'smartSearch.activitySearchStart': '正在执行结构化检索计划',
  'smartSearch.activitySearchDone': '当前返回 {n} 条，来自 {docs} 篇文档',
  'smartSearch.activitySearchPartial': '检索达到时间上限，保留 {n} 条已验证的部分结果',
  'smartSearch.searchError': '搜索失败',
  'smartSearch.openEditor': '在编辑器中打开',
  'smartSearch.emptyPrompt': '输入一个问题，相关笔记会立即出现在这里。',
  'smartSearch.settings': '智能查找设置',
  'smartSearch.lookup': '智能查找',
  'smartSearch.localAvailable': '没有 Agent 也可使用本地预览',
  'smartSearch.smartUnderstanding': '智能理解',
  'smartSearch.smartUnderstandingHint': '回车后只调用一次快速 Planner',
  'smartSearch.plannerProvider': '理解问题的 Agent',
  'smartSearch.auto': '自动',
  'smartSearch.plannerModel': '理解模型',
  'smartSearch.resultLimit': '结果数量',
  'smartSearch.groupBy': '结果分组',
  'smartSearch.groupSource': '来源',
  'smartSearch.groupDate': '日期',
  'smartSearch.autoDeep': '零结果时自动扩大查找',
  ...
  'smartSearch.includeRefs': '交接时包含当前选择',
  'smartSearch.activityPreviewReady': '保留本地即时预览',
  'smartSearch.plannerDisabled': '智能理解已关闭，当前展示普通匹配结果。',
  'smartSearch.plannerUnavailable': '没有可用的快速 Planner，当前展示普通匹配结果。',
  'smartSearch.questionTooLong': '问题超过快速理解预算，当前展示普通匹配结果。',
  'smartSearch.plannerFallback': '智能理解未完成，当前展示普通匹配结果。',
  'smartSearch.activityDeepStart': '正在限时扩大查找范围',
  'smartSearch.activityTime': '已应用时间范围：{range}',
  'smartSearch.activityTerms': '已识别主题：{terms}',
  'smartSearch.activitySummaryStart': '正在准备少量完整的当前匹配用于快速简答',
  'smartSearch.activitySummaryDone': '快速简答已完成，引文已校验',
  'smartSearch.summaryUnavailable': '无法生成快速简答。',
  'smartSearch.handoffCopied': '交接提示已复制',
  'smartSearch.activityHandoffStart': '正在启动独立的只读 Agent 研究任务',
  'smartSearch.activityHandoffDone': 'Agent 研究任务已启动',
  'smartSearch.handoffFailed': '无法启动 Agent 任务。',
  'smartSearch.returnedCount': '当前返回 {n} 条',
  'smartSearch.partialResults': '当前返回 {n} 条，结果可能未完全显示',
  'smartSearch.expandSearch': '扩大查找',
  'smartSearch.dateUnknown': '日期未知',
  'smartSearch.currentResult': '当前结果',
  'smartSearch.longBlockPreview': '这是 {type} 命中的有界预览；请打开原文阅读完整范围。',
  'smartSearch.copyRef': '复制引用',
  'smartSearch.copyMarkdown': '复制 Markdown 链接',
  'smartSearch.summaryLimitation': '只基于少量完整行块，且必须手动触发。',
  'smartSearch.generateSummary': '生成简答',
  'smartSearch.summaryNeedsLookup': '请先执行智能查找；快速预览不会发送给模型。',
  'smartSearch.summaryAgentUnavailable': '当前没有 Agent 支持 input-only 快速简答任务。',
  'smartSearch.summaryNeedsLine': '当前只有长文定位结果，请打开原文阅读；不能安全生成快速简答。',
  'smartSearch.summaryStale': '{n} 条来源已变化，已从本次简答中排除。',
  'smartSearch.basedOnMatches': '基于当前匹配结果，不代表完整 Vault',
  'smartSearch.copySummary': '复制简答',
  'smartSearch.handoff': '交给 Agent',
  'smartSearch.deepAgentRecommended': '这个问题需要深入阅读；当前引用只作为起点。',
  'smartSearch.handoffHint': 'Agent 会自行重搜、阅读原文，并以自己的身份申请 Memory。',
  'smartSearch.copyHandoff': '复制交接提示',
  'smartSearch.openAgentRun': '打开 Agent 任务',
  'smartSearch.staleNavigation': '文件已变化或索引位置已过期，建议刷新搜索索引。',
  'smartSearch.reasonExact': '精确',
  'smartSearch.reasonPhrase': '短语',
  'smartSearch.reasonFilename': '文件名',
  'smartSearch.reasonHeading': '标题',
  'smartSearch.reasonMultiple': '多路命中',
  'smartSearch.reasonRelated': '相关',
  'smartSearch.unsupported': '未支持约束',
  'smartSearch.ambiguous': '有歧义约束',
  'smartSearch.advancedSettings': '高级设置',
  'smartSearch.plannerTimeout': '理解等待时间（秒）',
  'smartSearch.deepTimeout': '扩大查找期限（秒）',
  'smartSearch.summaryProvider': '简答 Agent',
  'smartSearch.sameAsPlanner': '跟随 Planner',
  'smartSearch.summaryModel': '简答模型',
  'smartSearch.summarySources': '简答来源数',
  'smartSearch.summaryChars': '简答输入字符数',
  'smartSearch.summaryTimeout': '简答等待时间（秒）',
  'smartSearch.handoffProvider': '默认交接 Agent',
