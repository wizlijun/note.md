...
10. **Re-launch app** → previously-opened files appear in… (Note: Open Recent submenu is not yet implemented; recent list is stored in `~/Library/Application Support/com.laobu.mdeditor/settings.json`.)
