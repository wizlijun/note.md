...
export type Item =
  ...
  // A permission request and how it was answered. ACP-only: headless claude
  // pre-approves in settings.local.json and never asks at runtime.
...
export interface RunRecord {
  ...
  ended_at: string
  status: Status
  /** Always null under ACP: the protocol reports no turn count. */
...
export interface Task {
  ...
  /** The dsh sandbox preset this task runs under: read-only | workspace-write | danger-full-access. */
