...
export const api = {
  ...
  moveCorrectionEntry: (params: unknown): Promise<unknown> => bridge().request('plugin.move_correction_entry', params),
  mergeCorrectionEntries: (params: unknown): Promise<unknown> => bridge().request('plugin.merge_correction_entries', params),
